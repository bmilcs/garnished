...
export const EventUpdate: FC = () => {
  ...
  // pending status: fetch event data, delete event or update event

  if (isEventDataPending || isEventActionPending) {
    return <HourglassSpinner />;
  }

  // error status: event data fetch error or form data is missing
  // after pending status is set to false

  if (eventDataError || !formData) {
        ...
        <form onSubmit={handleSubmitForm}>
          ...
          <fieldset>
            ...
            <Input
              ...
              error={getExpressValidatorError("specialtyDrinks", updateErrors)}
            />
          </fieldset>
          ...
          <Input
            ...
            error={getExpressValidatorError("liquorPreferences", updateErrors)}
          />
