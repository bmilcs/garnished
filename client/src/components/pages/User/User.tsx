...
export const User: FC = () => {
  ...
  // pending status: waiting on user data fetch request to complete

  if (isPending) {
    return <HourglassSpinner />;
  }

  // error status: user data fetch error or no user data after
  // pending status is set to false
        ...
        <div className={styles.contentWrapper}>
          ...
          {userData.events.length > 0 ? (
            ...
            <div className="user-section-card">
              <h2 className={`h4 ${styles.userDetailsHeader}`}>Your Events</h2>
              <ul>
            ...
            <div className="user-section-card">
              <h2 className={`h4 ${styles.userDetailsHeader}`}>Your Events</h2>
              <p>
                You have no events scheduled. To create one, click on the Create
                New Event button below.
              </p>
            </div>
          )}
          ...
          <div className="user-section-card">
            <h2 className={`h4 ${styles.userDetailsHeader}`}>Personal Info</h2>
            <p>
