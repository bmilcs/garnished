...
const sendUpdatedEventEmailToOwners = async ({
  user,
  event,
}: TNewEventEmailTemplate) => {
  const subject = "An Event Has Been Changed!";
  const header = "An Event Has Been Changed!";
...
export default sendUpdatedEventEmailToOwners;
